		...
		<div class="max-w-3xl px-4 py-10 mx-auto">
			...
			<div x-show.transition="step === 'complete'">
				<div class="flex items-center justify-between p-10 bg-white rounded-lg shadow">
					<div>
						...
						<button
							@click="step = 1"
							class="block w-40 px-5 py-2 mx-auto font-medium text-center text-black bg-white border rounded-lg shadow-sm focus:outline-none hover:bg-gray-100" 
						>Back to home</button>
					</div>
				</div>
			</div>
			...
			<div x-show.transition="step != 'complete'">	
				...
				<div class="py-4 border-b-2">
					<div class="mb-1 text-xs font-bold leading-tight tracking-wide text-black uppercase" x-text="`Step: ${step} of 3`"></div>
					<div class="flex flex-col md:flex-row md:items-center md:justify-between">
						<div class="flex-1">
							<div x-show="step === 1">
								<div class="text-lg font-bold leading-tight text-black">Your Profile</div>
							</div>
							
							<div x-show="step === 2">
								<div class="text-lg font-bold leading-tight text-black">Your Password</div>
							</div>

							<div x-show="step === 3">
								<div class="text-lg font-bold leading-tight text-black">Tell me about yourself</div>
							</div>
						</div>

						<div class="flex items-center md:w-64">
							<div class="w-full mr-2 bg-white rounded-full">
								<div class="h-2 text-xs leading-none text-center text-black bg-green-500 rounded-full" :style="'width: '+ parseInt(step / 3 * 100) +'%'"></div>
							</div>
							<div class="w-10 text-xs text-black" x-text="parseInt(step / 3 * 100) +'%'"></div>
						</div>
					</div>
				</div>
				<!-- /Top Navigation -->
				...
				<div class="py-10">	
					<div x-show.transition.in="step === 1">
						<div class="mb-5 text-center">
							<div class="relative w-32 h-32 mb-4 bg-gray-100 border rounded-full mx-aut shadow-inset">
							...
							<label 
								for="fileInput"
								type="button"
								class="items-center justify-between px-4 py-2 font-medium text-left text-black bg-white border rounded-lg shadow-sm cursor-pointer inine-flex focus:outline-none hover:bg-gray-100"
							>
							...
							<div class="w-48 mx-auto mt-1 text-xs text-center text-black">Click to add profile picture</div>
						...
						<div class="mb-5">
							<label for="firstname" class="block mb-1 font-bold text-black">Firstname</label>
							<input type="text"
								class="w-full px-4 py-3 font-medium text-black rounded-lg shadow-sm focus:outline-none focus:shadow-outline"
								placeholder="Enter your firstname...">
						</div>

						<div class="mb-5">
							<label for="email" class="block mb-1 font-bold text-black">Email</label>
							<input type="email"
								class="w-full px-4 py-3 font-medium text-black rounded-lg shadow-sm focus:outline-none focus:shadow-outline"
					...
					<div x-show.transition.in="step === 2">
						...
						<div class="mb-5">
							<label for="password" class="block mb-1 font-bold text-black">Set up password</label>
							<div class="mt-2 mb-4 text-black">
							...
							<p class="mt-5 text-black-600">Inspired from dribbble shot: Exploration for a password strength meter by <a href="https://dribbble.com/OvertonGraphics" class="text-blue-500">Josh Overton</a>.</p>
						</div>
