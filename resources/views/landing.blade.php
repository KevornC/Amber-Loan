        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 p-6 sm:w-1/2">
            <h3 class="mb-3 text-3xl font-bold leading-none text-gray-800">
              Safe and Secure Loan Transfers
            </h3>
            <p class="mb-8 text-gray-600">
                We offer safe and secure loan transfers online once your documents have been validated and loan approved.
              <br />
              <br />
            </p>
          </div>
        ...
        <div class="flex flex-col flex-grow flex-shrink w-full p-6 md:w-1/3">
          ...
          <div class="flex-none p-6 mt-auto overflow-hidden bg-white rounded-t-none rounded-b shadow">
            <div class="flex items-center justify-start">
              <a href="{{route('apply')}}"><button class="px-8 py-4 mx-auto my-6 font-bold text-white transition duration-300 ease-in-out transform rounded-full shadow-lg lg:mx-0 hover:underline gradient focus:outline-none focus:shadow-outline hover:scale-105">
                Apply
              </button>
            </a>
            </div>
